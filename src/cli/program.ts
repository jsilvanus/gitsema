...
/**
 * Build the fully-configured `gitsema` Commander program, with all
 * subcommands registered and help formatting configured. Does not call
 * `program.parse()` — callers are responsible for parsing argv.
 */
