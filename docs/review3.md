...
The roadmap for Phase 48 onward has been moved to [`docs/PLAN.md`](./PLAN.md) (after the Phase 47 entry), where each planned phase is marked **(not yet implemented)**. Phase 48 (Batch Embedding) was implemented as part of this review cycle and is marked ✅ there.
