...
examples:
  - "Research: What are the current best embedding models for code and short prose? Provide sources."
  - "Find: List public docs for SQLite FTS5 and BM25 integration and cite pages."
selectionHints: |
